...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between rounded-lg  border-richblack-700 bg-[#e7f3ff] p-8 px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-lg  bg-[#e7f3ff] p-8 px-12">
