...
const Register = () => {
  return (
    <>
          <div className="min-h-screen bg-gray-100 text-gray-900 flex px-36 justify-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-8">
              ...
              <form className="mx-auto max-w-xs">
                ...
                <p className='text-center mt-2'>Already have an account?<Link className='text-indigo-800 font-semibold mx-2 hover:underline' to="/login">Login</Link></p>
